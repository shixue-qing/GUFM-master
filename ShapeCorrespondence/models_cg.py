...
def fmnet_model(phase, part_shot, model_shot, part_dist_map, model_dist_map, part_vert, model_vert, part_evecs, part_evecs_trans,
	...
	with tf.variable_scope("pointwise_corr_loss"):
		P_norm, unsupervised_loss = pointwise_corr_layer(net['C_est'], model_evecs, part_evecs, part_evecs_trans, model_dist_map, part_dist_map, part_vert, model_vert, part_valss, model_valss)
	...
	return unsupervised_loss, safeguard_inverse, merged, P_norm, net